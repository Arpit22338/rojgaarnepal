          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4 pt-4">
            {user?.role === "TEACHER" ? (
              ...
              <>
                <Link
                  href="/jobs"
                  className="inline-flex h-14 items-center justify-center px-8 py-3 text-lg font-bold text-primary-foreground bg-primary rounded-full hover:bg-primary/90 shadow-lg hover:shadow-primary/30 transition-all hover:scale-105 active:scale-95 group animate-pulse hover:animate-none"
                >
