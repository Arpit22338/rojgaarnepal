          ...
          <div style={{ zIndex: 10, width: "100%", textAlign: "center" }}>
            ...
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", marginTop: 40, paddingLeft: 24, paddingRight: 24 }}>
              <div style={{ textAlign: "center", display: "flex", flexDirection: "column", alignItems: "center", minWidth: 160 }}>
                <div style={{ fontSize: 14, fontWeight: 700, borderBottom: "2px solid #9ca3af", padding: "6px 12px", color: "#1f2937", minWidth: 120 }}>
                  {dateText}
                </div>
              ...
              <div style={{ textAlign: "center", display: "flex", flexDirection: "column", alignItems: "center", minWidth: 220 }}>
                <div style={{ minHeight: 90, display: "flex", alignItems: "center", justifyContent: "center" }}>
                  {signSrc ? (
                    /* eslint-disable-next-line @next/next/no-img-element */
                    <img src={signSrc} alt="Signature" style={{ height: 90, width: "auto", display: "block" }} />
                  ) : (
                    <div style={{ fontSize: 36, fontFamily: "cursive", color: "#1e3a8a" }}>Arpit</div>
                  )}
                </div>
