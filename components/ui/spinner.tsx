...
export const Dots_v1 = ({ ...props }: SpinnerProps) => (
...
export const Dots_v2 = ({ ...props }: SpinnerProps) => (
...
export const Dots_v3 = ({ ...props }: SpinnerProps) => {
    return (
...
export const Dots_v4 = ({ ...props }: SpinnerProps) => (
    <div className="flex items-center justify-center space-x-2" {...props}>
        {[...Array(3)].map((_, index) => (
            <motion.span
                key={index}
...
export const Dots_v5 = ({ ...props }: SpinnerProps) => {
    const dots = 8
    const radius = 24
